...
>
	...
	<div v-if="isRenote" :class="$style.renote">
		...
		<div :class="$style.renoteInfo">
			...
			<span v-if="note.visibility === 'public' && note.channel == null && note.user.isInHanaMode === true" style="margin-left: 0.5em;"><i class="ti ti-flower-filled"></i></span>
				...
				<div :class="$style.noteHeaderBody">
					<div>
						...
						<div :class="$style.noteHeaderInfo">
							<span v-if="appearNote.visibility === 'public' && appearNote.channel == null && appearNote.isNoteInHanaMode === true" style="margin-left: 0.5em;" :title="`${i18n.ts._visibility[note.visibility]} (${i18n.ts._hana.hanaMode})`"><i class="ti ti-flower-filled"></i></span>
