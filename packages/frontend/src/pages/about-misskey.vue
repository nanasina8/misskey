				...
				<FormSection>
					<div class="_gaps_s">
						...
						<FormLink to="https://github.com/taiyme/misskey" external>
							<template #icon><i class="ti ti-code"></i></template>
							{{ i18n.ts._aboutMisskey.source }} (taiyme)
							<template #suffix>GitHub</template>
						</FormLink>
						<FormLink to="https://github.com/hanamisskey/misskey" external>
							<template #icon><i class="ti ti-code"></i></template>
							{{ i18n.ts._aboutMisskey.source }} ({{ i18n.ts._hana.hanaMisskey }})
							<template #suffix>GitHub</template>
						</FormLink>
						<FormLink to="https://github.com/nanasina8/misskey" external>
							<template #icon><i class="ti ti-code"></i></template>
