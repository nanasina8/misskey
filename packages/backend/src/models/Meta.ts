...
export class MiMeta {
	...
	@Column('varchar', {
		length: 1024,
		default: 'https://github.com/nanasina8/misskey',
		nullable: true,
	})
	...
	@Column('varchar', {
		length: 1024,
		default: 'https://github.com/nanasina8/misskey/issues/new',
		nullable: true,
	})
	...
	public hanamiRecommendationAxisConfig: Record<string, { available?: boolean; default?: boolean }>;
